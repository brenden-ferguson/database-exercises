...
values ('Michael Jackson', 'Thriller', '1982', '47.3', 'Pop, Rock, R&B'),
       ...
       ('Whitney Houston / Various artists','The Bodyguard','1992','28.4','R&B, Soul, Pop, Soundtrack'),('The Eagles','Their Greatest Hits (1971–1975)','1976','32.2','Rock, Soft rock, Folk rock'),
       ('Bee Gees / Various artists','Saturday Night Fever','1977','21.6','Disco'),
       ('Fleetwood Mac','Rumours','1977','27.9','Soft rock'),
       ('Various artists','Grease: The Original Soundtrack from the Motion Picture','1978','14.4','Soundtrack'),('Led Zeppelin','Led Zeppelin IV','1971','29','Hard rock, Heavy metal, Folk'),
